...
# yves = User.create!(first_name: 'yves', last_name: 'Moinet', email: 'yves@mail.com', password: 'azerty', family_id: family1.id, direct_blood: false, birth_date: "Mar, 28 Mar 1986", city: "Lille", parent: jacotte)
  ...
  rodolphe = User.create!(first_name: 'rodolphe', last_name: 'Moinet', email: 'rodolphe.moinet@wanadoo.fr', password: 'azerty', family_id: family1.id, direct_blood: true, parent: jacotte, birth_date: "Mar, 28 Mar 1986", city: "Lille", phone: '0600000000')
