...
paulette = User.create!(first_name: 'Paulette', last_name: 'Duhamel', email: 'paulette@mail.com', password: 'azerty', family_id: family1.id, direct_blood: false, birth_date: "Mar, 28 Mar 1986", city: "Lille", phone: '0600000000', parent: léon)
...
marguerite_1 = User.create!(first_name: 'Marguerite', last_name: 'Duhamel', parent: léon, email: 'marguerite_1@mail.com', password: 'azerty', family_id: family1.id, direct_blood: true, birth_date: "Mar, 28 Mar 1986", city: "Lille", phone: '0600000000')
  ...
  nathalie_11 = User.create!(first_name: 'nathalie' last_name: 'Duhamel', parent: marguerite_1, email: 'nathalie_11@mail.com', password: 'azerty', family_id: family1.id, direct_blood: true, birth_date: "Mar, 28 Mar 1986", city: "Lille", phone: '0600000000')
    #3
    jean_baptiste = User.create!(first_name: 'jean-baptiste' last_name: 'Duhamel', parent: nathalie, email: 'jean-baptiste@mail.com', password: 'azerty', family_id: family1.id, direct_blood: true, birth_date: "Mar, 28 Mar 1986", city: "Lille", phone: '0600000000')
      #4
    ...
    #3
    pierre_1 = User.create!(first_name: 'pierre' last_name: 'Duhamel', parent: nathalie, email: 'pierre_1@mail.com', password: 'azerty', family_id: family1.id, direct_blood: true, birth_date: "Mar, 28 Mar 1986", city: "Lille", phone: '0600000000')
      #4
    ...
    #3
    laura = User.create!(first_name: 'laura' last_name: 'Duhamel', parent: nathalie, email: 'laura@mail.com', password: 'azerty', family_id: family1.id, direct_blood: true, birth_date: "Mar, 28 Mar 1986", city: "Lille", phone: '0600000000')
      #4
  ...
  #2
  jean_françois = User.create!(first_name: 'eugene' last_name: 'Duhamel', parent: marguerite_1, email: 'eugene@mail.com', password: 'azerty', family_id: family1.id, direct_blood: true, birth_date: "Mar, 28 Mar 1986", city: "Lille", phone: '0600000000')
    #3
...
léon_claude = User.create!(first_name: 'léon-claude', last_name: 'Duhamel', parent: léon, email: 'léon-claude@mail.com', password: 'azerty', family_id: family1.id, direct_blood: true, birth_date: "Mar, 28 Mar 1986", city: "Lille", phone: '0600000000')
  ...
  #2
  sophie_2 = User.create!(first_name: 'eugene' last_name: 'Duhamel', parent: léon_claude, email: 'eugene@mail.com', password: 'azerty', family_id: family1.id, direct_blood: true, birth_date: "Mar, 28 Mar 1986", city: "Lille", phone: '0600000000')
    #3
